...
> **Warning:** The mock service is for development only -- it uses deterministic keys. Never use it with real funds.

For build instructions and local setup, see [Installation & Setup](installation.md).
