...
| **Approval** | The request enters a pending state. A human must confirm via Passkey before the signature is produced. Used when the TEENet service itself enforces approval. |
