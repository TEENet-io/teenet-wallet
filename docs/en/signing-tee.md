...
The wallet reads its `APP_INSTANCE_ID` from the environment automatically during client construction. All subsequent key generation and signing calls use this ID.
